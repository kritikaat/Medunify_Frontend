        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="font-heading text-xl font-bold">MedUnify</span>
            </Link>
            <p className="text-background/60 text-sm leading-relaxed max-w-xs mb-6">
              Empowering patients to understand their health data through AI-powered insights and beautiful visualizations.
            </p>
        ...
        <div className="pt-8 border-t border-background/10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-background/60">
              © 2024 MedUnify. All rights reserved.
            </p>
            <p className="text-sm text-background/60 flex items-center gap-1">
              Made with <Heart className="w-4 h-4 text-error fill-current" /> for better health
            </p>
          </div>
        </div>
      </div>
